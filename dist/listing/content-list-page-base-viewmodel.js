(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'knockout', 'jquery', 'lodash', 'koco-url-utilities', 'koco', 'koco-query', 'koco-object-utilities', 'koco-string-utilities', 'koco-mapping-utilities', 'koco-disposer', 'koco-list-base-viewmodel'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('knockout'), require('jquery'), require('lodash'), require('koco-url-utilities'), require('koco'), require('koco-query'), require('koco-object-utilities'), require('koco-string-utilities'), require('koco-mapping-utilities'), require('koco-disposer'), require('koco-list-base-viewmodel'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.knockout, global.jquery, global.lodash, global.kocoUrlUtilities, global.koco, global.kocoQuery, global.kocoObjectUtilities, global.kocoStringUtilities, global.kocoMappingUtilities, global.kocoDisposer, global.kocoListBaseViewmodel);
        global.contentListPageBaseViewmodel = mod.exports;
    }
})(this, function (exports, _knockout, _jquery, _lodash, _kocoUrlUtilities, _koco, _kocoQuery, _kocoObjectUtilities, _kocoStringUtilities, _kocoMappingUtilities, _kocoDisposer, _kocoListBaseViewmodel) {
    'use strict';
